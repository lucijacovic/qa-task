...
class TestOne(BaseClass):
    ...
    def test_newsDesktop(self):
        ...
        # The first two elemnts should be “Siste 24 timer” and “Leder”
    ...
    def test_newsMobile(self):
        self.driver.set_window_size(360, 640) # mobile resolution, move this to conftest
        self.driver.implicitly_wait(3) # da dodje sebi
